...
with open('output.json', 'r', encoding='utf-8') as file:
    # Carregar dados JSON como uma lista
    data_list = json.load(file)

    # Iterar sobre cada dicionário na lista
    for app_dict in data_list:
        # Iterar sobre as chaves (IDs de aplicativos) no dicionário
        for app_id, app_data in app_dict.items():
            # Substituir ou remover caracteres não suportados na coluna 'name'
